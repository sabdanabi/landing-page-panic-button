...
<template>
  <nav class="mx-auto flex justify-between items-center w-full pt-4 font-poppins px-16 z-10 fixed bg-white drop-shadow-lg">
    <img src="/assets_image/logo-panic-button.png" alt="image-logo" class="w-16 mb-2 2xl:w-20">
    <div class="flex justify-between items-center 3xl:gap-36 lg:gap-1 md:gap-10 2xl:gap-20">
      ...
      <button class="bg-transparent border-2 border-mediumRed xl:py-1 xl:w-40 3xl:w-52 md:w-10 rounded-lg flex justify-center items-center xl:gap-4 md:py-2">
