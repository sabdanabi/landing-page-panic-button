...
<template>
    ...
    : 'absolute top-0 left-0 bg-transparent mx-auto']">
        ...
        <div class="flex justify-between items-center 3xl:gap-36 lg:gap-1 md:gap-10 2xl:gap-20">
          <ul class="flex space-x-9 xl:mr-10 3xl:gap-10 2xl:text-base 3xl:text-2xl
          md:text-xs lg:mr-10 text-mediumGrey xl:text-base lg:text-sm">
          ...
          xl:py-3 xl:w-40 3xl:w-52 xl:px-2 md:w-10 rounded-lg flex justify-center items-center xl:gap-4 md:py-2">
